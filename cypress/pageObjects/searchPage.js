class SearchPage {
    ...
    fliterMobilea(mobilea){
        cy.get('#brandsRefinements').contains(mobilea).click({ force: true });

    }
    fliterMobileb(mobileb){
        cy.get('#brandsRefinements').contains(mobileb).click({ force: true }); 
    }
}
